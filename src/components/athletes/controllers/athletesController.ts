...
const createAthlete = (req : Request, res : Response) => {
...
const editAthlete = (req : Request, res : Response) => {
        ...
        if(req.body.birthDate != null && req.body.birthDate != ""){
            //TODO Verifications
            if(true){
                connection.query<mysql.ResultSetHeader>(`UPDATE athletes SET athlete_initials = "${req.body.birthDate}" WHERE athlete_id = ${req.params.id};`)
